...
desired_chassis_state: Variable = p.variable(3) # vx, vy, w
desired_mod_states: VariableMatrix = p.variable(4, 2) # vx, vy
...
p.minimize((lerp_xy * trans_delta_mag + (5 * lerp_rot * rot_delta_mag)) * -1)
for i in range(4):
