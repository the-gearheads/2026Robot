...
public class CrossmapTarget implements AimingTarget {
    
    // this is only a seperate file to make code happy 
    ...
    public Rotation2d getHoodAngle(double distanceMeters) {
        return Rotation2d.fromRadians(0.3735);
    }
    ...
    public String toString() {
        return "CROSSMAP " + location.getX() + location.getY();
    }
