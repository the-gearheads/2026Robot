...
public class ShooterConstants {
    ...
    public static final double DEPOT_TRENCH_SHOOT_RPM = 5000; //MUST ACTUALLY INPUT VALUE THIS IS A PLACEHOLDER
    public static final Rotation2d DEPOT_TRENCH_SHOOT_ANGLE = new Rotation2d(30); //MUST ACTUALLY INPUT VALUE THIS IS A PLACEHOLDER
