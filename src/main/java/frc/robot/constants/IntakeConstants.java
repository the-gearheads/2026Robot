...
public class IntakeConstants {
    ...
    public static final float DEPLOY_ABS_ENC_OFFSET = (float)0.973;  // this must be in rotations
    ...
    public static final Rotation2d DEPLOY_SHIMMY_LOW_ANGLE = Rotation2d.fromDegrees(10); 
    public static final Rotation2d DEPLOY_SHIMMY_HIGH_ANGLE = Rotation2d.fromDegrees(55); 
    public static final double SHIMMY_DOWN_TIMEOUT = 0.8;  // will go up for x seconds, down for x, etc
    public static final double SHIMMY_UP_TIMEOUT = 0.55;  // will go up for x seconds, down for x, etc
