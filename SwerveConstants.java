...
public final class SwerveConstants {
    ...
    // ok drive's 14/13 teeth revs giving me mixed signals, spur's 22. 
    public static final double DRIVE_RATIO = 5.08:1; // idk how to format this will probably need to be fixed in shop
